...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/package-publishers/security/advisories/new)
...
- This repository (`hyperpolymath/package-publishers`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/package-publishers/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/package-publishers/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/package-publishers/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/package-publishers/discussions) |
